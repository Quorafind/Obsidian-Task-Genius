...
const translations = {
  ...
  "Incomplete version marker text": "Текст маркера незавершеного варіанту",
  ...
  "Incomplete custom marker text": "Текст нестандартного маркера незавершених завдань",
  ...
  "Move all incomplete subtasks to another file": "Перемістити всі незавершені підзавдання до іншого файлу",
  ...
  "You can modify all settings below. The original view will remain unchanged.": "Ви можете змінити всі налаштування нижче. Оригінальне видання залишиться незмінним.",
  ...
  "e.g. @home, @work": "наприклад: @додаток, @робота",
  "Recurrence Rule": "Правило повторення",
  "e.g. every day, every week": "наприклад, кожного дня, кожного тижня",
  ...
  "filter in this group": "фільтр у цій групі",
  ...
  "Select which task property to use for creating columns": "Виберіть, яке поле завдання використовувати для створення стовпців",
  ...
  "Default order to sort tasks within each column.": "Порядок за замовчуванням, за яким потрібно сортувати завдання в кожному стовпці.",
  ...
  "Task must have this priority (e.g., 1, 2, 3). You can also use 'none' to filter out tasks without a priority.": "Завдання повинні мати цей пріоритет (наприклад, 1, 2, 3). Ви також можете використовувати 'жоден', щоб фільтрувати завдання без пріоритету.",
  "Filter": "Фільтр",
  ...
  "Choose how to calculate the next date for recurring tasks": "Оберіть, як обчислити наступну дату для повторюваних завдань",
  ...
  "compatibility documentation": "документацію про сумісність",
  " for more information.": " для отримання додаткової інформації.",
  "Auto Date Manager": "Автоматичний менеджер дат",
  "Automatically manage dates based on task status changes": "Автоматично управляйте датами на основі змін стану завдання",
  "Enable auto date manager": "Увімкнути автоматичний менеджер дат",
  "Toggle this to enable automatic date management when task status changes. Dates will be added/removed based on your preferred metadata format (Tasks emoji format or Dataview format).": "Увімкніть це, щоб активувати автоматичне управління датами, коли стан завдання змінюється. Дати будуть додаватися/видалятися на основі вашого уподобаного формату метаданих (формат emoji завдань або формат Dataview).",
  "Manage completion dates": "Керування датами завершення",
  "Automatically add completion dates when tasks are marked as completed, and remove them when changed to other statuses.": "Автоматично додавати дати завершення, коли завдання вважаються завершеними, і видаляти їх, коли їх переводять в інші статуси.",
  "Manage start dates": "Керувати датами початку",
  "Automatically add start dates when tasks are marked as in progress, and remove them when changed to other statuses.": "Автоматично додавати дати початку, коли завдання позначені як в процесі, і видаляти їх, коли їх переводять в інші статуси.",
  "Manage cancelled dates": "Керування скасованими датами",
  "Automatically add cancelled dates when tasks are marked as abandoned, and remove them when changed to other statuses.": "Автоматично додавати дати скасування, коли завдання вважаються покинутими, і видаляти їх, коли їх переводять в інші статуси."
};
