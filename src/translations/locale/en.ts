...
const translations = {
	...
	"Choose the type of calendar source you want to add:":
		"Choose the type of calendar source you want to add:",
	"ICS/iCal URL": "ICS/iCal URL",
	"Add a calendar by providing an ICS/iCal URL":
		"Add a calendar by providing an ICS/iCal URL",
	...
	"Connect your iCloud Calendar using App-Specific Password":
		"Connect your iCloud Calendar using App-Specific Password",
	"Connect iCloud Calendar": "Connect iCloud Calendar",
	"Authenticate with Google to access your calendars":
		"Authenticate with Google to access your calendars",
	...
	"Sign in to your Google account and grant calendar permissions":
		"Sign in to your Google account and grant calendar permissions",
	"You will be redirected back to Obsidian automatically":
		"You will be redirected back to Obsidian automatically",
	...
	"Go to appleid.apple.com and sign in":
		"Go to appleid.apple.com and sign in",
	"Navigate to 'App-Specific Passwords' section":
		"Navigate to 'App-Specific Passwords' section",
	"Generate a new app-specific password for 'Obsidian Task Genius'":
		"Generate a new app-specific password for 'Obsidian Task Genius'",
	"Enter your Apple ID and the generated password below":
		"Enter your Apple ID and the generated password below",
	"Apple ID": "Apple ID",
	"Your Apple ID email address": "Your Apple ID email address",
	"App-Specific Password": "App-Specific Password",
	"The app-specific password generated for Obsidian":
		"The app-specific password generated for Obsidian",
	"Connecting...": "Connecting...",
	"Verifying credentials...": "Verifying credentials...",
	"Please enter both Apple ID and App-Specific Password":
		"Please enter both Apple ID and App-Specific Password",
	"iCloud Calendar connected successfully!":
		"iCloud Calendar connected successfully!",
	"iCloud Calendar authentication failed":
		"iCloud Calendar authentication failed",
	"Cloud Calendar Sources": "Cloud Calendar Sources",
	"ICS/iCal Sources": "ICS/iCal Sources",
	"Last Sync": "Last Sync",
	"Source disabled": "Source disabled",
	"Source enabled": "Source enabled",
	"Failed to toggle source: ": "Failed to toggle source: ",
	"Cloud calendar source deleted": "Cloud calendar source deleted",
	"Failed to delete source: ": "Failed to delete source: ",
	"Edit Cloud Calendar Source": "Edit Cloud Calendar Source",
	"Source Name": "Source Name",
	"Sync Settings": "Sync Settings",
	"Sync Past Days": "Sync Past Days",
	"Number of days in the past to sync": "Number of days in the past to sync",
	"Sync Future Days": "Sync Future Days",
	"Number of days in the future to sync":
		"Number of days in the future to sync",
